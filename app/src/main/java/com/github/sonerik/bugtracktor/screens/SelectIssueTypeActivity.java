...
import com.github.sonerik.bugtracktor.adapters.issue_types.IssueTypesItem;
...
public class SelectIssueTypeActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_select_issue_type;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        api.getIssueTypes(projectId, null)
           .compose(bindToLifecycle())
    ...
    private void initMembers(List<IssueType> issueTypes) {
        items.clear();
        items.addAll(Collections2.transform(issueTypes, it -> new IssueTypesItem(it, false)));
    }
}
